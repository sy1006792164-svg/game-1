...
function drawDeveloperPicker(r, game) {
  ...
  r.button('开始试玩', x + 22, y + 398, 174, CONTROL.height, () => game.developmentKey('Enter'),
    { style: 'primary', icon: 'play', disabled: developmentLevelNumber(modal.digits) === null });
  r.button('取消', x + 206, y + 398, 90, CONTROL.height, () => game.developmentKey('Escape'), { style: 'quiet', icon: 'close', size: 15 });
  return { x, y, w, h };
}
